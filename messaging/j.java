  ...
  extends a
{
  ...
  static
  {
    ...
    //   43: putstatic 66	com/whatsapp/messaging/j:a	[Ljava/security/cert/X509Certificate;
    //   46: iconst_1
    //   47: anewarray 68	javax/net/ssl/TrustManager
    //   50: dup
    //   51: iconst_0
    //   52: new 6	com/whatsapp/messaging/j$1
    //   55: dup
    //   56: invokespecial 70	com/whatsapp/messaging/j$1:<init>	()V
    //   59: aastore
    //   60: putstatic 72	com/whatsapp/messaging/j:b	[Ljavax/net/ssl/TrustManager;
    //   63: new 2	com/whatsapp/messaging/j
    //   66: dup
    //   67: aconst_null
    //   68: invokespecial 75	com/whatsapp/messaging/j:<init>	(Ljava/util/concurrent/atomic/AtomicReference;)V
    //   71: putstatic 77	com/whatsapp/messaging/j:c	Lcom/whatsapp/messaging/j;
    //   74: return
    //   75: astore_0
  ...
  public j(AtomicReference<Socket> paramAtomicReference)
  {
  ...
  protected final SSLSocketFactory a(final SSLContext paramSSLContext, SSLSessionCache paramSSLSessionCache)
  {
    try
    {
      ...
      paramSSLContext = new SSLSocketFactory()
      {
        ...
        {
          paramAnonymousString = paramSSLContext.createSocket(paramAnonymousString, paramAnonymousInt);
          j.a(j.this).set(paramAnonymousString);
        ...
        {
          paramAnonymousString = paramSSLContext.createSocket(paramAnonymousString, paramAnonymousInt1, paramAnonymousInetAddress, paramAnonymousInt2);
          j.a(j.this).set(paramAnonymousString);
          return paramAnonymousString;
        }
        ...
        {
          paramAnonymousInetAddress = paramSSLContext.createSocket(paramAnonymousInetAddress, paramAnonymousInt);
          j.a(j.this).set(paramAnonymousInetAddress);
        ...
        {
          paramAnonymousInetAddress1 = paramSSLContext.createSocket(paramAnonymousInetAddress1, paramAnonymousInt1, paramAnonymousInetAddress2, paramAnonymousInt2);
          j.a(j.this).set(paramAnonymousInetAddress1);
        ...
        {
          paramAnonymousSocket = paramSSLContext.createSocket(paramAnonymousSocket, paramAnonymousString, paramAnonymousInt, paramAnonymousBoolean);
          j.a(j.this).set(paramAnonymousSocket);
          return paramAnonymousSocket;
        }
        
        public final String[] getDefaultCipherSuites()
        {
          return paramSSLContext.getDefaultCipherSuites();
        }
        
        public final String[] getSupportedCipherSuites()
        {
          return paramSSLContext.getSupportedCipherSuites();
        }
      };
      return paramSSLContext;
    }
...
/* Location:              /home/chaitanya/sandbox/dex2jar-2.0/com.whatsapp-dex2jar.jar!/com/whatsapp/messaging/j.class
